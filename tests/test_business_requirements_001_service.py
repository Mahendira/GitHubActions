...
from app.business_requirements_001_service import BusinessRequirements001Service


class TestBusinessRequirements001Service(unittest.TestCase):
    def setUp(self):
        self.service = BusinessRequirements001Service()
